...
public class Runner {
    ...
    public static void test_PersonalData() {
        PersonalData pd = new PersonalData("Harsh Prakash Singh", 27, "M", "GEQPS7423B", "PAN", "IN", "BR", "800003");
    ...
    public static void test_UserCredentials() throws NotSerializableException, IOException, ClassNotFoundException {
        UserCredentials uc = new UserCredentials("piedaholic", "Harsh", "Prakash", "Singh", "hprakash1911@gmail.com",
                "ENG");
